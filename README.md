...
This allows easy extensibility by adding further 2-channel VC-panner boards mounted on their own panels daisy-chained from a header on the motherboard. I have indeed added an additional pair of inputs since originally building the module. Details of the construction are shown in the [pictures]() folder. Note that the two VC-panner boards mounted on the motherboard have the header pins on the front side on one board and the back side on the other to keep the wiring as clean as possible. Also most of the pin headers on the motherboard are on the back side.
